...
const Steps = () => {
  ...
  return (
    <div className="bg-[#f9f3eb] ">
      <div className="max-w-[1550px] w-[95%] mx-auto md:py-[5rem] py-6 ">
        <h1 className=" md:text-[2.6rem]  text-xl text-center font-semibold text-[#151515]">
          How to earn with Crypto
        </h1>

        <p className=" md:text-[1.4rem]  text-base mt-4 tracking-wide text-center md:py-2 py-1 font-semibold text-[#7a7a8c]">
        ...
        <div
          data-aos="fade-up"
          className="   md:flex flex-col justify-center   items-center py-[3rem] space-y-5"
        >
          <div className="flex gap-11 flex-col md:flex-row items-center">
          ...
          <div
            data-aos="fade-up"
            className="md:flex flex-col md:space-x-12 space-x-4 md:flex-row items-center justify-center"
          >
            <img className="" src={percentage} />
            <div className="">
          ...
          <div
            data-aos="fade-up"
            className="flex  md:space-x-12 space-x-4 flex-col md:flex-row items-center"
          >
            <img src={time} alt="" />
            <div className="">
              <h1 className="md:text-3xl text-xl font-semibold font-sans">
